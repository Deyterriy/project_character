...
def attack(char_name: str, char_class: str) -> str:
    """Считает количество нанесённого урона, взависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Считает количество заблокированного урона, взависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет способность, в зависимости от выбранного класса."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Начинает тренировку для выбранного класса, выдаёт текст с описанием класса.

        Подсказывает команды для игры. Также позволяет выйти из тренировки
        при вводе команды «skip».
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    Позволяет выбрать класс персонажа.
        ...
        Необходимо подтвердить свой выбор вводом команды «y» или «Y».
    """
    approve_choice: str = ''
    char_class: str = ''
